...
imageAlt: >-
  Cover card: KernMind, self-hosted and open source under the MIT license, built with Next.js, TypeScript, SQLite or Turso, a Chrome MV3 extension and Ollama.
order: 4
featured: true
---

KernMind is an open alternative to mymind.com: one place for everything worth remembering — notes, links, images, quotes, colors, products, books. The difference is where the data lives. KernMind runs on your own instance, the database is yours, and the AI layer works with your own API key.
